# EchoesOfTheArcane System

![Foundry v11](https://img.shields.io/badge/foundry-v11-green)

This system is a echoes-of-the-arcane system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

There are two ways to get started: using the EchoesOfTheArcane system generator command or manually renaming and updating files.
...
> **Python Generator**
> 
> If you would rather use Python than node, there’s an excellent Python-based generator created by Cussa at https://github.com/Cussa/fvtt-echoes-of-the-arcane-initializator. Give it a shot!
...
Head over to the [Vue3EchoesOfTheArcane System](https://gitlab.com/asacolips-projects/foundry-mods/vue3echoes-of-the-arcane) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/echoes-of-the-arcane.png)
